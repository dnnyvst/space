...
export const MOON_CONFIG: MoonConfigMap = {
  ...
  io: {
    ...
    orbitRadius: 3.25,
    orbitalTilt: PLANET_CONFIG.jupiter.axialTilt + 0.04,
    orbitPhase: Math.random() * Math.PI * 2,
    orbitalSpeed: 1.54,
    axialTilt: 0.05,
    textures: {
  ...
  europa: {
    ...
    orbitRadius: 3.75,
    orbitalTilt: PLANET_CONFIG.jupiter.axialTilt + 0.47,
    orbitPhase: Math.random() * Math.PI * 2,
    orbitalSpeed: 0.77,
    axialTilt: 0.1,
    textures: {
  ...
  ganymede: {
    ...
    orbitRadius: 4.25,
    orbitalTilt: PLANET_CONFIG.jupiter.axialTilt + 0.2,
    orbitPhase: Math.random() * Math.PI * 2,
    orbitalSpeed: 0.38,
    axialTilt: 0.33,
    textures: {
  ...
  callisto: {
    ...
    orbitRadius: 4.75,
    orbitalTilt: PLANET_CONFIG.jupiter.axialTilt + 0.28,
    orbitPhase: Math.random() * Math.PI * 2,
    orbitalSpeed: 0.16,
    axialTilt: 0.51,
    textures: {
